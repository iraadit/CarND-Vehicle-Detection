...
from yolo import (space_to_depth_x2,
...
def _main(args):
    ...
    weights_output_path = os.path.splitext(output_path)[0]+'_weights.h5'
    model.save_weights('{}'.format(weights_output_path))
    print('Saved Keras weights to {}'.format(weights_output_path))
